...
[CustomNodeGraphEditor(typeof(ComboSkillGraph))]
public class ComboSkillGraphEditor : NodeGraphEditor
{
    ...
    {
        if (type.Name == "ComboSkillSlotNode")
    ...
    private void UpdateNodePositionsAndTiers()
    {
        ...
        var tierField = typeof(ComboSkillSlotNode).GetField("tier", BindingFlags.Instance | BindingFlags.NonPublic);
        ...
        var indexField = typeof(ComboSkillSlotNode).GetField("index", BindingFlags.Instance | BindingFlags.NonPublic);
